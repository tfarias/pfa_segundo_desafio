...
<script src="{{ asset('lte/dist/js/mask.js') }}"></script>
<script src="{{ asset('lte/dist/js/money.js') }}"></script>
<script src="{{ asset('lte/dist/js/validator.js')}}"></script>
<script src="{{ asset('lte/dist/js/init.js')}}"></script>